...
namespace Database.Aniki
{
    public interface INpgsqlDbContext
    {
        ...
        int ExecuteNonQuery(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        Task<int> ExecuteNonQueryAsync(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        IDataReader ExecuteReader(NpgsqlCommand cmd);
        IDataReader ExecuteReader(NpgsqlCommand cmd, NpgsqlConnection connection);
        IDataReader ExecuteReader(NpgsqlConnection connection, NpgsqlTransaction? transaction, CommandType commandType, string commandText, NpgsqlParameter[] commandParameters);
        IDataReader ExecuteReader(string query, CommandType commandType);
        IDataReader ExecuteReader(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        Task<IDataReader> ExecuteReaderAsync(NpgsqlCommand cmd);
        Task<IDataReader> ExecuteReaderAsync(NpgsqlCommand cmd, NpgsqlConnection connection);
        Task<IDataReader> ExecuteReaderAsync(NpgsqlConnection connection, NpgsqlTransaction? transaction, CommandType commandType, string commandText, NpgsqlParameter[] commandParameters);
        Task<IDataReader> ExecuteReaderAsync(string query, CommandType commandType);
        Task<IDataReader> ExecuteReaderAsync(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        IDataReader ExecuteReaderSequential(NpgsqlCommand cmd);
        IDataReader ExecuteReaderSequential(NpgsqlCommand cmd, NpgsqlConnection connection);
        IDataReader ExecuteReaderSequential(NpgsqlConnection connection, NpgsqlTransaction? transaction, CommandType commandType, string commandText, NpgsqlParameter[] commandParameters);
        IDataReader ExecuteReaderSequential(string query, CommandType commandType);
        IDataReader ExecuteReaderSequential(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        Task<IDataReader> ExecuteReaderSequentialAsync(NpgsqlCommand cmd);
        Task<IDataReader> ExecuteReaderSequentialAsync(NpgsqlCommand cmd, NpgsqlConnection connection);
        Task<IDataReader> ExecuteReaderSequentialAsync(NpgsqlConnection connection, NpgsqlTransaction? transaction, CommandType commandType, string commandText, NpgsqlParameter[] commandParameters);
        Task<IDataReader> ExecuteReaderSequentialAsync(string query, CommandType commandType);
        Task<IDataReader> ExecuteReaderSequentialAsync(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        T? GetDataRow<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters) where T : class, new();
        ...
        Task<T?> GetDataRowAsync<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters) where T : class, new();
        ...
        DataTable GetDataTable(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        List<T> GetDataTable<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters) where T : class, new();
        ...
        Task<DataTable> GetDataTableAsync(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        Task<List<T>> GetDataTableAsync<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters) where T : class, new();
        ...
        List<T>? GetListOf<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        Task<List<T>?> GetListOfAsync<T>(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        object? GetScalar(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
        ...
        Task<object> GetScalarAsync(string query, CommandType commandType, NpgsqlParameter[] NpgsqlParameters);
    }
}