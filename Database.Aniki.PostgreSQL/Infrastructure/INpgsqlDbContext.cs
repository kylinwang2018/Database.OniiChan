...
namespace Database.Aniki
{
    public interface INpgsqlDbContext
    {
        ...
        int ExecuteNonQuery(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        Task<int> ExecuteNonQueryAsync(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        IDataReader ExecuteReader(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        Task<IDataReader> ExecuteReaderAsync(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        T? GetDataRow<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters) where T : class, new();
        ...
        Task<T?> GetDataRowAsync<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters) where T : class, new();
        ...
        DataTable GetDataTable(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        List<T> GetDataTable<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters) where T : class, new();
        ...
        Task<DataTable> GetDataTableAsync(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        Task<List<T>> GetDataTableAsync<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters) where T : class, new();
        ...
        List<T>? GetListOf<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        Task<List<T>?> GetListOfAsync<T>(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        object GetScalar(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
        ...
        Task<object> GetScalarAsync(string query, CommandType commandType, NpgsqlParameter[] sqlParameters);
    }
}