...
namespace Database.Aniki.Diagnostics
{
    /// <summary>
    ///     <para>
    ///		    String resources used in Database Aniki exceptions, etc.
    ///     </para>
    ///     <para>
    ...
    public static class AbstractionsStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Database.Aniki.Properties.AbstractionsStrings", typeof(AbstractionsStrings).Assembly);
